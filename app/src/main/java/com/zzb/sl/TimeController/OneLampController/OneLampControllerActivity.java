...
import com.zzb.sl.R;
import com.zzb.sl.TimeController.OneLampController.OneLampCustomView.ItemRemoveRecyclerView;
import com.zzb.sl.TimeController.OneLampController.OneLampCustomView.MyAdapter;
import com.zzb.sl.TimeController.OneLampController.OneLampCustomView.OnItemClickListener;
...
public class OneLampControllerActivity extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_one_lamp_controller);
        proj_srfl = (SwipeRefreshLayout) findViewById(R.id.onelamphost_list_srfl);
        itrr = (ItemRemoveRecyclerView) findViewById(R.id.onelamphost_re_container);
        onelamphost_list_img2 = (ImageView) findViewById(R.id.onelamphost_list_img2);
        onelamphost_list_img2.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void run() {
                ...
                if (hoseLists == null || hoseLists.size() <1){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(OneLampControllerActivity.this,R.string.Currentlynoinformation,1*1000);
                        }
                    });
                    //发送handler
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        final MyAdapter adapter = new MyAdapter(OneLampControllerActivity.this,hostList);
                        itrr.setLayoutManager(new LinearLayoutManagerWrapper(OneLampControllerActivity.this));
                        itrr.setAdapter(adapter);
                        LinearLayoutManager l = new LinearLayoutManager(OneLampControllerActivity.this);
                        ...
                        itrr.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                              Host ho = hostList.get(position);
                                ...
                                intent.setClass(OneLampControllerActivity.this, OneLampCActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putSerializable("SELECTUSER_ONELAMOHOST", ho);
