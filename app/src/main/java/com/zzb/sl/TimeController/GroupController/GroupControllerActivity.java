...
import com.zzb.sl.R;
import com.zzb.sl.TimeController.GroupController.GroupCustomView.ItemRemoveRecyclerView;
import com.zzb.sl.TimeController.GroupController.GroupCustomView.MyAdapter;
import com.zzb.sl.TimeController.GroupController.GroupCustomView.OnItemClickListener;
...
public class GroupControllerActivity extends SwipeBackActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        proj_srfl = (SwipeRefreshLayout) findViewById(R.id.groupc_list_srfl);
        itrr = (ItemRemoveRecyclerView) findViewById(R.id.groupc_re_container);
            ...
            public void run() {
                ...
                if (hoseLists == null || hoseLists.size() <1){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(GroupControllerActivity.this,R.string.Currentlynoinformation,1*1000);
                        }
                    });
                    //发送handler
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        final MyAdapter adapter = new MyAdapter(GroupControllerActivity.this,hostList);
                        itrr.setLayoutManager(new LinearLayoutManager(GroupControllerActivity.this));
                        itrr.setAdapter(adapter);
                        LinearLayoutManager l = new LinearLayoutManager(GroupControllerActivity.this);
                        ...
                        itrr.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                bundle.putSerializable("SELECTUSER_ONEGROUPHOSTC", ho);
