...
import com.zzb.sl.deviceManagement.LampManage.lamphostCustomView.ItemRemoveRecyclerView;
import com.zzb.sl.deviceManagement.LampManage.lamphostCustomView.MyAdapter;
import com.zzb.sl.deviceManagement.LampManage.lamphostCustomView.OnItemClickListener;
import com.zzb.sl.R;
...
public class LampHostActivity extends SwipeBackActivity {
    ...
    private ImageView lamphost_list_img2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lamp_host);
        proj_srfl = (SwipeRefreshLayout) findViewById(R.id.lamphost_list_srfl);
        itrr = (ItemRemoveRecyclerView) findViewById(R.id.lamphost_re_container);
        lamphost_list_img2 = (ImageView) findViewById(R.id.lamphost_list_img2);
        lamphost_list_img2.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void run() {
                ...
                if (hoseLists == null || hoseLists.size() <1){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(LampHostActivity.this,R.string.Currentlynoinformation,1*1000);
                        }
                    });
                    //发送handler
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        final MyAdapter adapter = new MyAdapter(LampHostActivity.this,hostList);
                        itrr.setLayoutManager(new LinearLayoutManager(LampHostActivity.this));
                        itrr.setAdapter(adapter);
                        LinearLayoutManager l = new LinearLayoutManager(LampHostActivity.this);
                        ...
                        itrr.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                intent.setClass(LampHostActivity.this, LampManageActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putSerializable("SELECTUSER_LAMPHOST", ho);
            ...
            public void run() {
                ...
                if(selectUList1.get(0).getsS_Project() == null || selectUList1.get(0).getsS_Project() ==""){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(LampHostActivity.this, getString(R.string.Currentlynoinformation), 1 * 1000);
                        }
                    });
                    //发送handler
                    Message msg_listData = new Message();
