...
import com.zzb.sl.R;
import com.zzb.sl.deviceManagement.SubManage.subhostCustomView.ItemRemoveRecyclerView;
import com.zzb.sl.deviceManagement.SubManage.subhostCustomView.MyAdapter;
import com.zzb.sl.deviceManagement.SubManage.subhostCustomView.OnItemClickListener;
...
public class SubHostActivity extends SwipeBackActivity {
    private static final String TAG ="SubHostActivity" ;
    ...
    private ImageView subhost_list_img2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sub_host);
        proj_srfl = (SwipeRefreshLayout) findViewById(R.id.subhost_list_srfl);
        itrr = (ItemRemoveRecyclerView) findViewById(R.id.subhost_re_container);
        subhost_list_img2 = (ImageView) findViewById(R.id.subhost_list_img2);
        subhost_list_img2.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void run() {
                ...
                if (hoseLists == null || hoseLists.size() <1){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(SubHostActivity.this,R.string.Currentlynoinformation,1*1000);
                        }
                    });
                    //发送handler
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        final MyAdapter adapter = new MyAdapter(SubHostActivity.this,hostList);
                        itrr.setLayoutManager(new LinearLayoutManager(SubHostActivity.this));
                        itrr.setAdapter(adapter);
                        LinearLayoutManager l = new LinearLayoutManager(SubHostActivity.this);
                        ...
                        itrr.setOnItemClickListener(new OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                intent.setClass(SubHostActivity.this, SubManageActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putSerializable("SELECTUSER_SUBHOST", ho);
            ...
            public void run() {
                ...
                if(selectUList1.get(0).getsS_Project() == null || selectUList1.get(0).getsS_Project() ==""){
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ActivityUtil.showToasts(SubHostActivity.this, getString(R.string.Currentlynoinformation), 1 * 1000);
                        }
                    });
                    //发送handler
                    Message msg_listData = new Message();
