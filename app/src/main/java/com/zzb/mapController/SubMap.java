...
import com.zzb.sl.R;
import com.zzb.sl.deviceManagement.SubManage.SubInfoManageActivity;
...
public class SubMap extends SwipeBackActivity implements AMap.OnMapClickListener, View.OnClickListener {
    ...
    private void getJw(LatLng latLng, final Class c){
        ...
        ActivityUtil.showToasts(SubMap.this,"经纬度["+latitude+","+longitude+"]",1*1500);
        //设置对话框标题
        new AlertDialog.Builder(SubMap.this).setTitle("经纬度设置")
                ...
                .setPositiveButton(getResources().getString(R.string.OK),new DialogInterface.OnClickListener() {//添加确定按钮
                    ...
                    public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                        ...
                        Intent inte = new Intent(SubMap.this, c);
