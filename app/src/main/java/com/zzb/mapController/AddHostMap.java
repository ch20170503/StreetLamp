...
import com.zzb.sl.R;
import com.zzb.sl.deviceManagement.HostManage.AddHostActivity;
...
public class AddHostMap extends SwipeBackActivity implements AMap.OnMapClickListener, View.OnClickListener {
    ...
    public void onMapClick(LatLng latLng) {
        getJw(latLng, AddHostActivity.class);
    }
    ...
    private void getJw(LatLng latLng, final Class c){
        ...
        ActivityUtil.showToasts(AddHostMap.this,"经纬度["+latitude+","+longitude+"]",1*1500);
        //设置对话框标题
        new AlertDialog.Builder(AddHostMap.this).setTitle("经纬度设置")
                ...
                .setPositiveButton(getResources().getString(R.string.OK),new DialogInterface.OnClickListener() {//添加确定按钮
                    ...
                    public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                        ...
                        Intent inte = new Intent(AddHostMap.this, c);
